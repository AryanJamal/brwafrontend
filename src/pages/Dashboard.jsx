...
import { DollarSign, Calendar, TrendingUp, Users, Wallet, CreditCard } from 'lucide-react';
    ...
    useEffect(() => {
        const fetchBonusData = async () => {
            try {
                ...
                const dailyResponse = await api.bonuses.getDaily();
                const monthlyResponse = await api.bonuses.getMonthly();
        ...
        fetchBonusData();
    }, []); // The useEffect dependency is now an empty array to fetch data once on mount

    // فانکشنی نوێکردنەوەی داتا
